...
<template>
    <ProviderSiteLayout title="My Bookings">
                                ...
                                <div v-for="booking in upcomingBookings" :key="`${booking.type}-${booking.id}`" class="booking-card">
                                    ...
                                    <div class="booking-body">
                                        <h3 class="booking-title">
                                            ...
                                            <template v-else-if="isEventBooking(booking)">
                                                {{ booking.event.name }}
                                            </template>
                                        </h3>
                                        ...
                                        <div class="booking-details">
                                            ...
                                            <template v-if="isEventBooking(booking)">
                                                ...
                                                <div class="detail-item">
                                                    <i :class="booking.event.location_type === 'virtual' ? 'pi pi-video' : 'pi pi-map-marker'"></i>
                                                    <span>{{ booking.event.location_type === 'virtual' ? 'Virtual' : (booking.event.location || 'In Person') }}</span>
                                                </div>
                                            </template>
                            ...
                            <div v-if="pastBookings.length > 0" class="bookings-list">
                                <div v-for="booking in pastBookings" :key="`${booking.type}-${booking.id}`" class="booking-card booking-card--past">
                                    ...
                                    <div class="booking-actions">
                                        ...
                                        <template v-else-if="isEventBooking(booking)">
                                            <AppLink :href="getEventUrl(booking)">
                                                <Button label="View Event" severity="secondary" size="small" />
                                            </AppLink>
                                        </template>
                                    </div>
                                </div>
