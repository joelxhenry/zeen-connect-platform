            ...
            <form @submit.prevent="submit">
                <div class="form-field">
                    ...
                    <InputText id="email" v-model="form.email" type="email" placeholder="Enter your email"
                        :class="{ 'p-invalid': form.errors.email }" autofocus />
                    <small v-if="form.errors.email" class="p-error">{{ form.errors.email }}</small>
                </div>

                <div class="form-field">
                    <label for="password">Password</label>
                    <Password id="password" v-model="form.password" placeholder="Enter your password" :feedback="false"
                        toggleMask :class="{ 'p-invalid': form.errors.password }" inputClass="w-full" />
                ...
                <Button type="submit" label="Login" :loading="form.processing" class="submit-btn" />
            </form>
