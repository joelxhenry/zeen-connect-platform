...
<template>
    <BoutiqueLayout :title="event.name">
            ...
            <div class="page-container">
                ...
                <div class="event-header">
                    <div class="header-eyebrow">
                        <span v-if="event.categories.length > 0">{{ event.categories[0].name }}</span>
                        <span v-if="event.event_type === 'recurring'" class="recurring-tag">Recurring</span>
                    </div>
                    <h1>{{ event.name }}</h1>
                ...
                <div class="content-layout">
                    ...
                    <div class="booking-sidebar">
                        <div class="booking-card">
                            ...
                            <Button v-else label="No Dates Available" class="btn-book" disabled />
