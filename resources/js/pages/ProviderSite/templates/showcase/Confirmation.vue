                    ...
                    <div class="card-body">
                        ...
                        <template v-if="isEventBooking">
                            <div class="detail-row">
                                ...
                                <span class="detail-value price-value">{{ eventBooking.total_amount_display }}</span>
                            </div>
                            <div class="detail-row highlight">
                                <span class="detail-label">DEPOSIT REQUIRED</span>
                                <span class="detail-value price-value">{{ eventBooking.deposit_amount_display }}</span>
                            </div>
                        </template>
                        ...
                        <template v-else>
                            <div class="detail-row">
                                ...
                                <span class="detail-value price-value">${{ serviceBooking.service_price.toFixed(2) }}</span>
                            </div>
                            <div v-if="serviceBooking.fee_payer === 'client' && serviceBooking.convenience_fee > 0" class="detail-row">
                                <span class="detail-label">SERVICE FEE</span>
                                <span class="detail-value price-value">${{ serviceBooking.convenience_fee.toFixed(2) }}</span>
                            </div>
                            <div class="detail-row highlight">
                                <span class="detail-label">DEPOSIT REQUIRED</span>
                                <span class="detail-value price-value">${{ serviceBooking.deposit_amount.toFixed(2) }}</span>
                            </div>
                            <div class="detail-row muted">
                                <span class="detail-label">BALANCE DUE AT APPOINTMENT</span>
                                <span class="detail-value price-value">${{ serviceBooking.balance_amount.toFixed(2) }}</span>
                            </div>
                        </template>
