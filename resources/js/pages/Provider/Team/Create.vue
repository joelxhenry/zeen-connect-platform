...
<template>
    <ConsoleLayout title="Invite Team Member">
        <div class="w-full max-w-2xl mx-auto">
            <!-- Page Header -->
            <div class="mb-6">
                <h1 class="text-xl lg:text-2xl font-semibold text-[#0D1F1B] m-0 mb-1">Invite Team Member</h1>
                <p class="text-gray-500 m-0 text-sm lg:text-base">
                    Add someone to help manage your business
                </p>
            </div>

            <!-- Extra charge warning -->
            <Message v-if="teamInfo.would_exceed_free_slots" severity="warn" :closable="false" class="mb-6">
            ...
            <form @submit.prevent="submit" class="bg-white rounded-xl shadow-sm p-6">
                ...
                <!-- Name (required for direct, optional for invite) -->
                <div class="mb-6">
                ...
                <div v-if="inviteMode === 'direct'" class="mb-6">
