        ...
        <div class="w-full max-w-3xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 m-0 text-sm lg:text-base ml-6">
                    Update your service details and booking settings
                </p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-red-200">
                    <div class="px-4 lg:px-5 py-3 lg:py-4 border-b border-red-200 bg-red-50">
                        <h2 class="text-sm lg:text-base font-semibold text-red-700 m-0">Danger Zone</h2>
                    </div>
