...
<template>
    <ConsoleLayout :title="`Booking - ${booking.service.name}`">
        <div class="max-w-4xl mx-auto">
            ...
            >
                <span class="font-medium">This appointment is today!</span>
                <span class="ml-2">{{ booking.formatted_time }}</span>
            </ConsoleAlertBanner>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <!-- Client Info Card -->
                    <ConsoleFormCard :title="booking.client.is_guest ? 'Guest Information' : 'Client Information'" icon="pi pi-user">
                    ...
                    <ConsoleFormCard title="Appointment Details" icon="pi pi-calendar">
                    ...
                    <!-- Payment Card -->
                    <ConsoleFormCard title="Payment Information" icon="pi pi-wallet">
                ...
                <div class="space-y-6">
                    <!-- Status Card -->
                    <ConsoleFormCard title="Status" icon="pi pi-info-circle">
                    ...
                    <!-- Actions Card -->
                    <ConsoleFormCard title="Actions" icon="pi pi-bolt">
                        <div class="space-y-3">
            ...
            >
                ...
                <template #footer>
                    <ConsoleButton label="Go Back" variant="secondary" @click="showCancelDialog = false" />
                    <ConsoleButton
