    ...
    <DefaultLayout title="Events">
        <div class="events-page">
            <div class="page-container">
                ...
                <!-- Events by Category -->
                <div v-if="hasEvents" class="categories-list">
                    <div v-for="(categoryGroup, index) in eventsByCategory" :key="categoryGroup.category?.id ?? `uncategorized-${index}`" class="category-section">
